import { CheckCircle, XCircle, Clock, Users, Layers, ChevronDown, ChevronUp } from "lucide-react";
  ...
  return (
    <Card className="mb-4 border-border bg-card/50 animate-scale-in">
      ...
      <CardContent className="space-y-3">
        ...
        {(result.plan || (result.extracted_data && Object.keys(result.extracted_data).length > 0)) && (
          <div className="pt-2">
            <Button
              variant="ghost"
              size="sm"
              ...
              <div className="space-y-3 mt-3">
                ...
                {result.extracted_data && Object.keys(result.extracted_data).length > 0 && (
                  <div>
                    ...
                    <div className="bg-muted/50 rounded-md p-3 text-xs font-mono mt-2 overflow-x-auto">
